...
type FriendApply struct {
	...
	FromUserId int64  `gorm:"not null;index:idx_from_user,priority:1" json:"from_user_id"`
	ToUserId   int64  `gorm:"not null;index:idx_to_user,priority:2" json:"to_user_id"`
