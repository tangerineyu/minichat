...
func SetupGroupRoutes(appRouterGroup *AppRouterGroup, h *di.HandlerProvider) {
	...
	appRouterGroup.AuthRouterGroup.POST("/group/dissolve", h.GroupHandler.DissolveGroup)
	appRouterGroup.AuthRouterGroup.POST("/group/update_info", h.GroupHandler.UpdateGroupInfo)
